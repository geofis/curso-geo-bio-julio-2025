...
Las sesiones serán de 2 horas; en cada una, se hará una breve introducción de conocimientos, seguida de una sesión práctica. Se utilizarán herramientas de mesa y digitales provistas por el profesor.
...
- [Meteorización y su importancia sobre la distribución de los seres vivos](`r paste0(github_pages_url_general, 'media/tema-2-intro.html')`)
